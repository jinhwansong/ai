  ...
  return (
    <section className="space-y-4">
      <div className="flex items-end justify-between px-2">
        <h3 className="text-xl font-bold text-(--text-title)">실시간 주요 뉴스</h3>
        <button className="text-xs font-bold text-(--primary-strong) hover:underline">전체보기</button>
      </div>
        ...
        {news.map((item, index) => (
          ...
          >
            <div className="flex-1 space-y-2">
              ...
              <h4 className="text-base font-bold text-(--text-title) group-hover:text-(--primary-strong) transition-colors">
                {item.title}
              </h4>
